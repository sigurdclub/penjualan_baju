...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link" style="text-decoration: unset;">
      ...
      <span class="brand-text font-weight-light">FansFruits</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block" style="text-decoration: unset;">Helma</a>
        </div>
      </div>
        ...
        <div class="row" style="justify-content: center;width: 100%;" >
          <div class="card" style="width: 50%;">
            ...
            <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
              <div class="col-12">
                <label for="inputAddress" class="form-label">Nama Buah</label>
                <input type="text" class="form-control" id="inputAddress" placeholder="Apple..." name="nama_buah" >
              </div>
              <div class="col-12">
              ...
              <div class="col-12">
                ...
                <input type="text" class="form-control" id="inputAddress2" placeholder="15000" name="harga">
              </div>
              <div class="col-12">
                <label for="inputAddress2" class="form-label">Satuan</label>
                <input type="text" class="form-control" id="inputAddress2" placeholder="2" name="satuan">
              </div>
              <div class="col-12">
                <label for="inputAddress2" class="form-label">Gambar</label>
                <input type="file" class="form-control" id="inputAddress2" placeholder="" name="gambar">
              </div>
